...
${OBJECTDIR}/Cocktailmixer.o: Cocktailmixer.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Cocktailmixer.o Cocktailmixer.cpp
...
${OBJECTDIR}/Geraet.o: Geraet.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Geraet.o Geraet.cpp

${OBJECTDIR}/MischbaresRezepteBuch.o: MischbaresRezepteBuch.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MischbaresRezepteBuch.o MischbaresRezepteBuch.cpp

${OBJECTDIR}/Mischbehaelter.o: Mischbehaelter.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Mischbehaelter.o Mischbehaelter.cpp
...
${OBJECTDIR}/MyTimer.o: MyTimer.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MyTimer.o MyTimer.cpp
...
${OBJECTDIR}/Zutatenliste.o: Zutatenliste.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Zutatenliste.o Zutatenliste.cpp
